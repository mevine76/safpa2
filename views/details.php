...
<div class="row justify-content-center">
    <?php
    foreach (Animal::getAnimalById() as $animal) { ?>


        <div class="card mb-5" style="max-width: 1000px;">
            <div class="row g-0">
                <div class="col-md-4 mt-5">
                    <a href="../controllers/controller-details.php?id=<?= $animal['id'] ?>"><img src="/assets/img/<?= $animal['img'] ?>" class="img-fluid rounded" alt="image animaux"></a>
                ...
                <div class="col-md-8">
                    <div class="card-body ms-3 mt-0">
                        ...
                        <p class="card-text"><strong> Image: </strong> <?= $animal['img'] ?> </p>
